...
export interface RadialDonutChartState {
  value: any;
}

export class RadialDonutChart extends React.Component<RadialDonutChartProps, RadialDonutChartState> {
  public readonly state: RadialDonutChartState = {
    value: false,
  }
